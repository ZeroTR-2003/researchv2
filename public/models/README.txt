...
- christuskirche-exterior.glb
- heroes-acre-exterior.glb
- windhoek-city-museum-exterior.glb

Tip: use Draco-compressed glTF to reduce size.


<iframe id="tour-embeded" name="Windhoek City Museum" src="https://tour.panoee.net/iframe/68e2979e57effdfd21a09ccc" frameBorder="0" width="100%" height="400px" scrolling="no" allowvr="yes" allow="vr; xr; accelerometer; gyroscope; autoplay;" allowFullScreen="false" webkitallowfullscreen="false" mozallowfullscreen="false" loading="eager"></iframe>
      <script>
...
Please i need this application to be very proffesionla , please use fonts of : @import url('https://fonts.googleapis.com/css2?family=Sora:wght@400;600;700&display=swap');
. Please style my web application and make it the best. please styel my cards as for a very very top designer. Pleease also use sites like to introduces free components from here : https://reactbits.dev/components/ . Please the images i was giving for how that design was, please help me on createing that top design not as that , but a proffesionla and best design as that. Please use this to for or navbar https://reactbits.dev/components/staggered-menu :  where npx shadcn@latest add https://reactbits.dev/r/StaggeredMenu-TS-TW or import React, { useCallback, useLayoutEffect, useRef, useState } from 'react';
...
. Please also use some components,